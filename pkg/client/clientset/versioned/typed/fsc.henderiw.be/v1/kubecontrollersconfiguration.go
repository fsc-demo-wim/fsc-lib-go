...
func newKubeControllersConfigurations(c *FscV1Client, namespace string) *kubeControllersConfigurations {
...
func (c *kubeControllersConfigurations) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.KubeControllersConfiguration, err error) {
	result = &v1.KubeControllersConfiguration{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *kubeControllersConfigurations) List(ctx context.Context, opts metav1.ListOptions) (result *v1.KubeControllersConfigurationList, err error) {
...
func (c *kubeControllersConfigurations) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *kubeControllersConfigurations) Create(ctx context.Context, kubeControllersConfiguration *v1.KubeControllersConfiguration, opts metav1.CreateOptions) (result *v1.KubeControllersConfiguration, err error) {
	result = &v1.KubeControllersConfiguration{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("kubecontrollersconfigurations").
...
func (c *kubeControllersConfigurations) Update(ctx context.Context, kubeControllersConfiguration *v1.KubeControllersConfiguration, opts metav1.UpdateOptions) (result *v1.KubeControllersConfiguration, err error) {
	result = &v1.KubeControllersConfiguration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kubecontrollersconfigurations").
...
func (c *kubeControllersConfigurations) UpdateStatus(ctx context.Context, kubeControllersConfiguration *v1.KubeControllersConfiguration, opts metav1.UpdateOptions) (result *v1.KubeControllersConfiguration, err error) {
	result = &v1.KubeControllersConfiguration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kubecontrollersconfigurations").
...
func (c *kubeControllersConfigurations) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *kubeControllersConfigurations) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *kubeControllersConfigurations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.KubeControllersConfiguration, err error) {
	result = &v1.KubeControllersConfiguration{}
