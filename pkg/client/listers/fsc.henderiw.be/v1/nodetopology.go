...
// NodeTopologies returns an object that can list and get NodeTopologies.
func (s *nodeTopologyLister) NodeTopologies(namespace string) NodeTopologyNamespaceLister {
	return nodeTopologyNamespaceLister{indexer: s.indexer, namespace: namespace}
}

// NodeTopologyNamespaceLister helps list and get NodeTopologies.
// All objects returned here must be treated as read-only.
...
// nodeTopologyNamespaceLister implements the NodeTopologyNamespaceLister
// interface.
type nodeTopologyNamespaceLister struct {
	indexer   cache.Indexer
	namespace string
}

// List lists all NodeTopologies in the indexer for a given namespace.
func (s nodeTopologyNamespaceLister) List(selector labels.Selector) (ret []*v1.NodeTopology, err error) {
...
// Get retrieves the NodeTopology from the indexer for a given namespace and name.
func (s nodeTopologyNamespaceLister) Get(name string) (*v1.NodeTopology, error) {
